...
export async function noteList(opts: {
	projectId: number;
	limit?: number;
	cursor?: string;
...
export async function noteCreate(opts: {
	projectId: number;
	content: string;
}): Promise<{ note: Note }> {
...
export async function noteUpdate(opts: {
	id: number;
	content: string;
}): Promise<{ note: Note }> {
...
export async function reminderList(opts?: {
	projectId?: number;
	state?: ReminderState;
	limit?: number;
	cursor?: string;
...
export async function reminderCreate(opts: {
	projectId: number;
	content: string;
...
export async function reminderSetState(opts: {
	id: number;
	state: ReminderState;
}): Promise<{ reminder: Reminder }> {
...
export async function crossProjectOverview(): Promise<{
